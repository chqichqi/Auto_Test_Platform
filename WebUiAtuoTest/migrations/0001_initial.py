    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('FrontPostManager', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='WebUiAtuoTest.frontpostmanager', verbose_name='前/后置用例步骤')),
                ('Product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='WebUiAtuoTest.product', verbose_name='所属项目')),
                ('SeleniumHubServer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='WebUiAtuoTest.seleniumhubserver', verbose_name='SeleniumServer服务器')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('WebCase', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='WebUiAtuoTest.webcase', verbose_name='用例前/后置条件')),
            ],
            options={
                'verbose_name': '测试步骤',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('FrontPostManager', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='WebUiAtuoTest.frontpostmanager', verbose_name='前/后置条件')),
            ],
            options={
                'verbose_name': '前/后置用例',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('DdtData', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='WebUiAtuoTest.ddtdata', verbose_name='数据驱动项')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='ddtdata',
            name='WebCase',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='WebUiAtuoTest.webcase', verbose_name='测试用例'),
        ),
        migrations.CreateModel(
            name='CaseContext',
            fields=[
                ...
                ('argvValue', models.CharField(max_length=1024, verbose_name='参数值')),
                ('WebCase', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='WebUiAtuoTest.webcase', verbose_name='测试用例')),
            ],
            options={
