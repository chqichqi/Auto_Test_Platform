...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('WebUiAutoTest', '0011_auto_20231110_2256'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='webcase',
            name='Product',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='WebUiAutoTest.product', verbose_name='所属项目+版本'),
        ),
        migrations.AlterField(
